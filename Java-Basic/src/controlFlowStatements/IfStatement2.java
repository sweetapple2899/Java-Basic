...
public class IfStatement2 {
	...
	public static void main(String[] args) {
		...
		if ((asset <= 50) && (sales <= 300)) {
			System.out.println("Classification \t\t\t\t: Mikro Company");
			
		} else if ((asset <= 500) && (sales <= 2500)) {
			System.out.println("Classification \t\t\t\t: Small Company");
			
		} else if ((asset <= 10000) && (sales <= 50000)) {
			System.out.println("Classification \t\t\t\t: Medium Company");
			
		} else {
			System.out.println("Classification \t\t\t\t: Big Company");
		}
